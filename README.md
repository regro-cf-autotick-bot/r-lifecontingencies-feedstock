...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-lifecontingencies-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-lifecontingencies-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add r-lifecontingencies
# for installing globally
pixi global install r-lifecontingencies
```
...
It is possible to list all of the versions of `r-lifecontingencies` available on your platform:
...
```
pixi search r-lifecontingencies --channel conda-forge
```
